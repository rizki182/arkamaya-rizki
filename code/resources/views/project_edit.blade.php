            ...
            <div class="card">
              ...
              <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="textfield" class="form-control project_form" id="project_start" placeholder="Project Start" value="{{ $project->project_start }}">
                    </div>
                    <div class="form-group">
                      <label for="project_end">Project End</label>
                      <input type="textfield" class="form-control project_form" id="project_end" placeholder="Project End" value="{{ $project->project_end }}">
                    </div>
                    <div class="form-group">
                      <label for="project_status">Project Status</label>
                      <select class="form-control project_form" id="project_status">
                        @foreach ($project_status::cases() as $status)
                            @if ($project->project_status == $status->value)
